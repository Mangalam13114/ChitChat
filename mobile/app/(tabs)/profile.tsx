    ...
    >
      ...
      <View className="relative">
        <View className="items-center mt-10">
          ...
          {/* { STATUS BADGE } */}
          <View className="flex-row items-center text-center mt-3 bg-green-500/20 px-3 py-1.5 rounded-full">
          ...
          <View className="bg-surface-card rounded-2xl overflow-hidden">
            {section.items.map((item, index) => (
              ...
              >
                ...
                {item.value && <Text className="text-subtle-foreground text-sm mr-1">{item.value}</Text>}
